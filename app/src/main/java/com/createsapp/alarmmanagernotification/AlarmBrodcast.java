...
public class AlarmBrodcast extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            String channedId = "channel_id";
            NotificationChannel channel = new NotificationChannel(channedId,"channel name", NotificationManager.IMPORTANCE_HIGH);
            channel.enableVibration(true);
            notificationManager.createNotificationChannel(channel);
            mBuilder.setChannelId(channedId);
        }
